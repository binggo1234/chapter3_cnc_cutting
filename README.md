...
最终主方法的论文理论表述见 `docs/formal_theory_event_gated_beam_ls.md`。该文档将 `process_aware_beam_adaptive_polished` 对齐为 `Event-gated Adaptive beam+LS`，并给出状态约束序列决策定义、词典序工艺目标、事件门控性质、伪代码和复杂度边界。
